...
// MapItem represents a key-value pair in a MapSlice
type MapItem struct {
        Key   interface{}
        Value interface{}
}

// MapSlice is an ordered map that preserves key order
type MapSlice []MapItem

// UnmarshalYAML implements yaml.Unmarshaler for MapSlice
...
// MarshalYAML implements yaml.Marshaler for MapSlice
